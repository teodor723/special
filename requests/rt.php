...
// Require authentication for real-time messaging
requireAuth();
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    switch ($_GET['action']) {
        case 'message':
            ...
            $results = $mysqli->query("SELECT s_id FROM chat WHERE r_id = ".$r_id." AND seen = 0 AND notification = 0 ORDER BY id DESC");  
