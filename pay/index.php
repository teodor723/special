        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" id="lwPaymentForm" class="box-shadow-credits">
                    <div class="card">
                        <div class="card-header box-shadow" style="background:#000">
                        ...
                        <div class="card-body">
                            ...
                            <?php 
                                ...
                                <button type="submit" id="button-payment" value="<?= $sm['lang'][877]['text']; ?>" class="btn btn-lg btn-block btn-success box-shadow"><?= $sm['lang'][877]['text']; ?></button>
      ...
      <div class="modal-dialog">
        <div class="modal-content" style="border:none;">
          <div class="modal-body" style="padding:0">
            <div class="card" id="customPayment" style="display: none;border:none">
                <div class="card-header" style="background:#2f2f2f">
                    <h4 class="card-title text-center" 
                        id="customPaymentTitle" 
                        style="color: #fff;font-weight:bold;margin-bottom: 0;">
                    </h4>
                </div>
                ...
                <div class="card-body mb-3" data-proof-form="send">
                    ...
                    <div class="" style="position:relative;padding: 15px;background: #fef8ff;border-radius: 5px;font-size: 16px;margin-bottom: 15px;padding-top: 20px;">
                        <ul class="list-group mb-3">
                            <li class="list-group-item d-flex justify-content-between lh-condensed box-shadow-credits">
                              <div>
                                <h6 class="my-0"><?= $item_name;?></h6>
                                <small class="text-muted" id="customPaymentName"></small>
                              </div>
                              <span><?= $sm['plugins']['settings']['currency']; ?> <?=$USD_price; ?></span>
                            </li>
                        </ul>   
                        <div style="position:relative;width: 100%;">

                        <p class="text-center" data-custom-payment-external-url>
                            <?= $sm['lang'][1022]['text']; ?>
                        </p>
                        ...
                        style="color:#a00065;font-weight: 500;font-size: 18px;margin-top: 30px;"></p>
                        </div>           
                    </div>
                    <p class="text-center" style="margin-bottom:40px;padding-right:20px;padding-left:20px">
                    ...
                    <form action="" id="submitCustomPayment">
                        ...
                        <button type="submit" id="button-custom-payment" class="btn btn-lg btn-block btn-success box-shadow"><?= $sm['lang'][1028]['text']; ?></button>
                    </form>
                </div>
